...
<div class="row menu-grande-bg">
    <div class="container menu-grande">
                <a href="index.php"> <img src="img/jean_logo_spaced.png" border="0"  ></a>
    ...
    <div id="myCarousel" class="carousel slide" >
      <div class="carousel-inner">
        <div class="item active">
          <img src="img/slides/slide-01.jpg" alt="">
          <div class="container">
        ...
        <div class="item">
          <img src="img/slides/slide-02.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
              <h1>Pailería</h1>
        ...
        <div class="item">
          <img src="img/slides/slide-03.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
